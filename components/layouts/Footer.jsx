...
const socialLinks = [
  {
    icon: Github,
    href: "https://github.com/PavanTalluri45?tab=repositories",
    label: "GitHub",
  },
  {
    icon: Linkedin,
...
export default function Footer() {
  ...
  const resumePath =
    "https://drive.google.com/file/d/1KUZDQNMiaVejq-wrNu1uuN0khqrPX1M5/view?usp=drive_link";
  ...
  return (
    <footer
      id="footer"
      className="relative bg-background border-t border-border/50 py-16 overflow-hidden"
    >
      <div className="w-full px-6 md:px-12 lg:px-16 xl:px-24 relative z-10">
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground text-base leading-relaxed max-w-md">
                A full-stack engineer with a strong analytical foundation who
                builds end-to-end digital systems and transforms data into
                strategic insight.
              </p>
            </div>
        ...
        <div className="border-t border-border/40 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>
            © {new Date().getFullYear()} Pavan Kumar Talluri. All rights
            reserved.
          </p>
